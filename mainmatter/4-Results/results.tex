...
\begin{figure}[H]
    \centering
    \subfloat[Actual Scores]{\includegraphics[width=.46\textwidth]{mainmatter/4-Results/images/train_y.png}
    \label{fig:train_actual}}
    \subfloat[Predicted Scores]{\includegraphics[width=.46\textwidth]{mainmatter/4-Results/images/pred_train_y.png}
    \label{fig:train_predict}
    } \qquad

    \subfloat[Difference of Actual and Predicted Scores]{\includegraphics[width=.5\textwidth]{mainmatter/4-Results/images/train_diff.png}
