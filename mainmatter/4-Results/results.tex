...
\begin{figure}[tbp]
    ...
    \subfloat[S1][Setting 1]{
        \includegraphics[width=.2\textwidth]{mainmatter/4-Results/images/S1.png}
        \label{fig:s1}
    }
    \subfloat[S2][Setting 2]{
        \includegraphics[width=.2\textwidth]{mainmatter/4-Results/images/S2.png}
        \label{fig:s2}
    }
    \subfloat[S3][Setting 3]{
        \includegraphics[width=.2\textwidth]{mainmatter/4-Results/images/S3.png}
        \label{fig:s3}
    }
    \subfloat[S4][Setting 4]{
        \includegraphics[width=.2\textwidth]{mainmatter/4-Results/images/S4.png}
        \label{fig:s4}
    }
...
The comparison between the scores evaluated in same dataset has been compared and presented in table \ref{table:results_comparison} \cite{ozturk2018deepdta}. 
